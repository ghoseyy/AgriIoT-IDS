...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run Optuna search for the VAE baseline.")
    ...
    parser.add_argument("--output", type=Path, default=Path("experiments/vae/optuna_results.json"))
...
def main() -> None:
    ...
    try:
        ...
        from agri_iot_ids.training.engine import evaluate_scores, fit_vae, score_vae, select_threshold, save_json
    except ModuleNotFoundError as exc:
