...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train a variational autoencoder baseline on CIC-IDS-2017.")
    ...
    parser.add_argument("--output", type=Path, default=Path("experiments/vae/results.json"))
    ...
    parser.add_argument("--checkpoint", type=Path, default=Path("experiments/vae/model.pt"))
    parser.add_argument("--report", type=Path, default=Path("experiments/vae/report.md"))
    parser.add_argument("--loss-plot", type=Path, default=Path("experiments/vae/loss.png"))
    parser.add_argument("--score-plot", type=Path, default=Path("experiments/vae/scores.png"))
...
def main() -> None:
    ...
    try:
        ...
        from agri_iot_ids.training.engine import evaluate_scores, fit_vae, score_vae, select_threshold
    except ModuleNotFoundError as exc:
    ...
    print(f"Saved VAE results to {args.output}")
